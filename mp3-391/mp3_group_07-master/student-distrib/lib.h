...
void putc(uint8_t c);
extern void putc_offsite(uint8_t c);
...
/* Outputs screen locations */
extern int output_x();
extern int output_y();

/* Changes the screen location */
void reset_x();
void check_x();
extern void check_y();
...
/* CTRL_C Helper Function */
void ctrlc_y();

/* Helper Function to change screen_x and screen_y*/
extern void change_x(int32_t input_x);
extern void change_y(int32_t input_y);
